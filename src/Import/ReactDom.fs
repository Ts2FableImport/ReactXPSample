...
type [<AllowNullLiteral>] Renderer =
    ...
    [<Emit "$0($1...)">] abstract Invoke: element: ReactElement<'P> * container: Element option * ?callback: (unit -> unit) -> U3<Component<'P, ComponentState>, Element, unit>
    [<Emit "$0($1...)">] abstract Invoke: element: Array<ReactElement<obj option>> * container: Element option * ?callback: (unit -> unit) -> U3<Component<obj option, ComponentState>, Element, unit>
