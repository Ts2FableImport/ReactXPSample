...
let [<Global>] config: Config' = jsNative
...
module Raceable =
    let ofTOption v: Raceable<'T> = v |> Microsoft.FSharp.Core.Option.map U2.Case1
    ...
    let ofThenableOption v: Raceable<'T> = v |> Microsoft.FSharp.Core.Option.map U2.Case2
